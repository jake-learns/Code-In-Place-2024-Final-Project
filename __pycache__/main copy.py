...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.return_to_idle_neg_1 = [ pygame.image.load("spaceship\Working Folder\\turn_down_half_moving.png").convert_alpha(),  pygame.image.load("idle.png").convert_alpha()]
        self.return_to_idle_1 = [ pygame.image.load("spaceship\Working Folder\\turn_up_half_moving.png").convert_alpha(),  pygame.image.load("idle.png").convert_alpha()]
...
while running:
    ...
    if menu:
        ...
        if start_button.update():
            start_button.image = pygame.image.load("resume_yellow.png").convert_alpha()
    ...
    if game_over:
        ...
        if restart_button.update():
            ...
            score = 0
            player_lives = 3
            start_button.image = pygame.image.load("start_yellow.png").convert_alpha()
            respawn()
            boss_group.empty()
            game_over = False
            menu = True
